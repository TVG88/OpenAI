...
import Advantive from "../../assets/LogoAdvantive.png";
                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Advantive HR Chatbot</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Begin met chatten of stel een vraag</h2>
                            </Stack>
                        ) : (
